 ...
 * @modified Thursday, March 9, 2016 Mr. Roller */
...
public class Decider 
{
	...
	// When you are asked to rate, you will be given a name. Reply verbally 
 	// with the rating of that person as given below:
